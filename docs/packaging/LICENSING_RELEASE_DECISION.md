...
Audit date: 2026-09-12. This records the Ticket 14 public-distribution boundary.
...
| SCA implementation/install dependency | No | No explicit licence established | `EXCLUDED_FROM_PUBLIC_RELEASE` |
...
an optional separately authorized compatible validation backend.
