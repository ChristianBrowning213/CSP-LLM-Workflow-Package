...
from tests.helpers.solve_test_support import DummySPP, assign_sequential_solution, base_request


def _schema_validator():
    schema = json.loads((Path(__file__).resolve().parents[1] / "docs" / "mcp" / "MCP_SCHEMA.json").read_text())
